      ...
      <div className="w-full px-3 max-w-5xl mx-auto flex justify-center">
        <section className="text-center p-10 md:p-16  rounded-[2.5rem] shadow-sm w-full max-w-2xl">
          ...
          <p className="n2 text-lg text-slate-500 leading-relaxed mb-10 max-w-md mx-auto">
            요청하신 작업을 처리하는 중에
            <br />
            예상치 못한 오류가 발생했습니다.<br></br>잠시 후 다시 시도해 주세요.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              onClick={() => reset()}
              className="px-10 py-4 bg-rose-400 hover:bg-rose-500 text-white font-bold rounded-2xl shadow-lg shadow-rose-100 transition-all active:scale-95"
            >
              다시 시도하기
            </button>
            <Link
